...
and datasets can appropriately used together. Given the increasing number of high-quality public datasets and
...
substantially\GK{}{note: statistically significantly better?} better than chance and outperform recommendations made by
...
These datasets are coming from various sources distributed in Canada and abroad and include different data modalities that are mostly "brain imaging", "human pain", "mri", "neuroimaging" and "structural mri". \MM{we illustrated the keywords not modalities}
...
\begin{subfigure}{.53\textwidth}  \includegraphics[width=\columnwidth]{figures/Commented Success Percentage.pdf}
  \caption{Experts predictions. Shades of green represent the fraction of experts who predicted successful execution. Gray means no data.\GK{}{Label axes, colourbar, and add plot title}}
  \label{fig:experts_matrix}
\end{subfigure} \hfill
\begin{subfigure}{.45\textwidth}
  \includegraphics[width=\columnwidth]{figures/Pipeline Execution Level 2.pdf}
  \caption{Pipeline outcomes. Green represents successful execution, red represents failures and gray represents no data.\GK{}{Label axes, colourbar, and add plot title. Should be the same height as the other plot.}}
  \label{fig:execution_matrix}
\end{subfigure}
...
\begin{figure}
  ...
  \caption{Expert confidence by actual execution outcome.\GK{}{This plot is unclear to me... Start with labelling both axes more clearly, but based on the clear quantization of the data, consider comparing stacked histograms instead of box plots?}}
...
\begin{table}[htbp]
    \caption{Execution failure causes \GK{}{I just skimmed the text around this, but what is the "dataset not available" error really meaning? It's a large fraction and the current presentation makes its significance unclear.}}
    \begin{center}
        \begin{tabular}{cc}
            \hline
...
\centering
  ...
  \caption{ROC curves of experts and recommender system predictions. \GK{}{change the colour of one of the lines, expert and recommender are too similar.}}
  \label{fig:roc-curve}
\end{figure}
...
\begin{table}
    ...
    \begin{tabular}{cc}
        ...
        &
    \end{tabular}
    \caption{Pipeline names \GK{}{It might be worth having their DOIs, too?}}
...
\begin{table}
    ...
    \begin{tabular}{cc}
        ...
        &
    \end{tabular}
    \caption{Dataset names \GK{}{It might be worth having their DOIs, too?}}
